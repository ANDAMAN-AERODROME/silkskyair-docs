---
title: "Keyword Multi-Locale Sync"
---

# Keyword Multi-Locale Sync

> **App:** BackOffice (with verification on the public WebSite)
...
- **Prerequisites:** the Strapi sync token is configured for staging BackOffice (already true). A published Sky Story exists for verification on the public site.
...
![Step 1 — Taxonomy view](/screenshots/sky-stories/keyword-multi-locale-sync/01-taxonomy-view.png)
...
![Step 2 — New keyword form (English tab)](/screenshots/sky-stories/keyword-multi-locale-sync/02-new-keyword-form-en.png)
...
![Step 3 — Filling Thai tab](/screenshots/sky-stories/keyword-multi-locale-sync/03-filling-thai-tab.png)
...
![Step 4 — Keyword saved](/screenshots/sky-stories/keyword-multi-locale-sync/04-keyword-saved.png)
...
![Step 5 — Public site English](/screenshots/sky-stories/keyword-multi-locale-sync/05-public-en.png)
...
![Step 6 — Public site Thai](/screenshots/sky-stories/keyword-multi-locale-sync/06-public-th.png)
...
- **What if the Strapi sync fails?** The Save button still enables and the keyword lands in Supabase. The Strapi side is async — a sync failure is logged but not surfaced in the UI. If a keyword is missing from the public site after a few minutes, check Strapi admin or the BackOffice logs.
